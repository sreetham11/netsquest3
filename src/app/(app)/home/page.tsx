  ...
  return (
    <div>
      {/* Two-column on desktop: wallet controls (left, fixed) / stats + activity
          (right, flexible). On mobile this collapses to a single stacked column,
          in DOM order — which is also the order product asked for. */}
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-[380px_1fr] lg:items-start">
        ...
        <div className="flex flex-col gap-6">
          ...
          {/* Top-up, inline under the card rather than embedded in it */}
          ...
          {/* Quick actions — icon over label, minimal border, not boxed */}
        ...
        {/* Right column */}
        <div className="flex flex-col gap-6">
          {/* Spending Plan, as plain stat tiles instead of a donut chart */}
          <div className="grid grid-cols-3 gap-3">
            <StatCard
